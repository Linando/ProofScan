...
class MatchPrefixCell: UITableViewCell {

    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
        let switchView = UISwitch(frame: .zero)
        switchView.setOn(UserDefaults.standard.bool(forKey: "ImageMatchPrefix"), animated: false)
    ...
    @objc func valueChanged(sender: UISwitch) {
        ...
        UserDefaults.standard.set(sender.isOn, forKey: "ImageMatchPrefix")
